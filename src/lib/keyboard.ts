...
// 结构化按键信号：只取本模块关心的几个字段，真实 KeyboardEvent 天然满足，
// 同时允许测试用部分对象构造 mock。
...
export function isComposingEvent(e: KeyEventLike | null, composingFlag: boolean): boolean {
...
export function shouldSendOnEnter(e: KeyEventLike | null, composingFlag: boolean): boolean {
