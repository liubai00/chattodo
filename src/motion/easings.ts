...
// ──────── P14 Linear 切换 Token（Grill 锁定）────────
// 路由、TaskDetail、大浮层
export const DURATION_COMPLEX = 0.35
...
export const SCALE_DRAG_START = 1.05
export const ROTATE_DRAG = 1      // deg
...
export const DURATION_ROUTE = 0.35 // 350ms：路由滑入（P14 升级自 300ms）
