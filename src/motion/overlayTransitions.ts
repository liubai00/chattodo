...
export function onOverlayRightEnter(el: Element, done: () => void) {
  ...
  try {
    ...
    console.error('[overlay right enter]', e)
    done()
  }
}
...
export function onOverlayCenterEnter(el: Element, done: () => void) {
  ...
  try {
    ...
    console.error('[overlay center enter]', e)
    done()
  }
}
