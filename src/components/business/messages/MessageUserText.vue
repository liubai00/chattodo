...
<template>
  ...
  <template v-else>
    <div v-message-enter class="flex flex-col items-end gap-[5px] self-end" style="max-width:78%;">
      ...
      <div :title="m.time || ''" class="rounded-2xl bg-[var(--accent)] px-[14px] py-2.5 text-sm font-medium leading-relaxed text-[var(--accent-contrast)]" style="white-space:pre-wrap;">{{ m.text }}</div>
